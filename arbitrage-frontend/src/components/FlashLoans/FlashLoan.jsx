...
export const FlashLoan = () => {
  ...
  const calculateArbitrage = () => {
    ...
    const nonCommonTokenFirstPair = selectedPair1Data ? (selectedPair1Data.token0symbol === sharedTokenY ? selectedPair1Data.token1symbol : selectedPair1Data.token0symbol) : null;
      ...
      <Form layout="vertical">
        <Form.Item label="First Swap Pair" style={{ width: "20vw" }}>
          ...
          <div className="text-block">
            ...
            {selectedPair1Data && (
              <Text type="secondary">
                {selectedPair1Data.priceToken1String}
              </Text>
            )}
            {selectedPair1Data && (
              <Text type="secondary">
                {selectedPair1Data.priceToken0String}
              </Text>
            )}
          </div>
        </Form.Item>
        <Form.Item label="Second Swap Pair" style={{ width: "20vw" }}>
          ...
          <div className="text-block">
            ...
            {selectedPair2Data && (
              <Text type="secondary">
                {selectedPair2Data.priceToken1String}
              </Text>
            )}
            {selectedPair2Data && (
              <Text type="secondary">
                {selectedPair2Data.priceToken0String}
              </Text>
            )}
          </div>
        </Form.Item>
        <Form.Item label="Stablecoin Conversion Pair" style={{ width: "20vw" }}>
          ...
          {availableStablePair && (
            <>
              ...
              <Text type="secondary">
                {availableStablePair.prieToken0String}
              </Text>
            </>
          )}
        </Form.Item>
        ...
        <Button type="primary" onClick={calculateArbitrage}>
          Make An Arbitrage Using Flash Loan
        </Button>
      </Form>
      {error && (
